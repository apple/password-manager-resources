...
//
//   1. Validates it parses cleanly by loading tools/PasswordRulesParser/PasswordRulesParser.js and
...
const parserPath = path.join(repoRoot, "tools", "PasswordRulesParser", "PasswordRulesParser.js");
